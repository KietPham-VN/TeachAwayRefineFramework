...
with tab1:
    st.markdown(
        "<h2 style='color: #FFC81B;'>F-Code [Techaway 2024]</h2>",
        unsafe_allow_html=True,
    )
...
6. Demo
Bạn có thể xem thử dự án mẫu trên Refine.dev hoặc tạo một ứng dụng CRUD đơn giản theo hướng dẫn ở phần trên.
...
Tài liệu tham khảo:
Refine Documentation: Overview | Refine
GitHub Repository: GitHub - refinedev/refine: A React Framework for building internal tools, admin panels, dashboards & B2B apps with unmatched flexibility. 
